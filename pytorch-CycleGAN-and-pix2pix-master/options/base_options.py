...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters   #数据原始大小26*35
        parser.add_argument('--dataroot', default='./datasets/hanzi2jiagu/P_CD', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--name', type=str, default='experiment_256', help='name of the experiment. It decides where to store samples and models')
